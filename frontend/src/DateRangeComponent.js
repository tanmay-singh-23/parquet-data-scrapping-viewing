// frontend/src/DateRangeComponent.js
...
const DateRangeComponent = () => {
    ...
    const fetchTripsByDateRange = async () => {
        try {
            const response = await axios.get(`http://localhost:8000/trips/daterange?start=${startDate}&end=${endDate}`);
    ...
    return (
        <div className="table-container">
            ...
            <div className="inputstyle">
                ...
                <button onClick={fetchTripsByDateRange}>Fetch Trips</button>
            </div>
            <table>
                <thead>
                    <tr>
