// frontend/src/DriverPayRangeComponent.js

import React, { useState } from 'react';
import axios from 'axios';
import './styles.css';

const DriverPayRangeComponent = () => {
    ...
    return (
        <div className="table-container">
            <h2>Trips by Driver Pay Range</h2>
            <div className="inputstyle">
                ...
                <label>
                    Max Pay:
                    <input type="number" value={maxPay} onChange={(e) => setMaxPay(e.target.value)} />
                </label>
                <button onClick={fetchTripsByDriverPayRange}>Fetch Trips</button>
            </div>
            <table>
                <thead>
                    <tr>
...
export default DriverPayRangeComponent;
