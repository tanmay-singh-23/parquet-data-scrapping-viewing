// frontend/src/TimeRangeComponent.js
...
const TimeRangeComponent = () => {
    ...
    const fetchTripsByTimeRange = async () => {
        try {
            const response = await axios.get(`http://localhost:8000/trips/timerange?min=${minTime}&max=${maxTime}`);
    ...
    return (
        <div className="table-container">
            ...
            <div className="inputstyle">
                ...
                <button onClick={fetchTripsByTimeRange}>Fetch Trips</button>
            </div>
            <table>
                <thead>
                    <tr>
